	...
	def _connectCPUElements(self):
		...
		self.EX_MEM_Wall.connect(
			[(self.EXadder, "output"), (self.ALogicUnit, "result"),
			 (self.ID_EX_Wall, "Reg2"), (self.RegDstMux, "RegDstoutput")],
			["adderoutput", "result", "Reg2", "regdstoutput"],
		...
		self.storage.connect(
			[(self.EX_MEM_Wall, "result"), (self.EX_MEM_Wall, "Reg2")],
			["data"],
